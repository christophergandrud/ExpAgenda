...
#' @param TopicLabels character vector. Labels for each topic. Should be in the same order as the topics generated by \code{\link{TopicSummary}}.
#'  
...
DocTopics <- function(obj, TopicLabels = NULL){
